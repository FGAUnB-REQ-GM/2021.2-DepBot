...
## Histórico de Versões <!-- {docsify-ignore} -->
|Data|Versão|Modificação|Autores|
|:---|:-----|:----------|:------|
|03/02/2022|1.0|Criação do documento com o link|Victor Cabral|

## Link para o vídeo presente na plataforma YouTube: <!-- {docsify-ignore} -->
...
## 1. Visão Geral do Produto <!-- {docsify-ignore} -->

### 1.1 Declaração do Problema <!-- {docsify-ignore} -->
| | |
|:-|:-|
...
### 1.2 Declaração de Posição do Produto <!-- {docsify-ignore} -->
...
### 1.3 Objetivos do Produto <!-- {docsify-ignore} -->
...
## 2. Abordagem de Desenvolvimento de Software <!-- {docsify-ignore} -->
...
## 3. Abordagem de Engenharia de Requisitos <!-- {docsify-ignore} -->
...
## 4. Lições Aprendidas <!-- {docsify-ignore} -->
...
## Referências Bibliográficas <!-- {docsify-ignore} -->
